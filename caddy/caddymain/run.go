...
import (
	...
	"github.com/haochudao/caddyserver-caddy_v1.0.3"
	"github.com/haochudao/caddyserver-caddy_v1.0.3/caddyfile"
	"github.com/haochudao/caddyserver-caddy_v1.0.3/caddytls"
	"github.com/haochudao/caddyserver-caddy_v1.0.3/telemetry"
	"github.com/google/uuid"
	"github.com/klauspost/cpuid"
	"github.com/mholt/certmagic"
	lumberjack "gopkg.in/natefinch/lumberjack.v2"

	_ "github.com/haochudao/caddyserver-caddy_v1.0.3/caddyhttp" // plug in the HTTP server type
...
func getBuildModule() *debug.Module {
	...
	if ok {
		...
		for _, mod := range bi.Deps {
			if mod.Path == "github.com/haochudao/caddyserver-caddy_v1.0.3" {
				return mod
			}
		}
	}

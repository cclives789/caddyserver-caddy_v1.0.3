...
func MakeTLSConfig(configs []*Config) (*tls.Config, error) {
	...
	return &tls.Config{
		...
		// only GetConfigForClient set. https://github.com/haochudao/caddyserver-caddy_v1.0.3/pull/2404
...
//
// See https://github.com/haochudao/caddyserver-caddy_v1.0.3/issues/1674

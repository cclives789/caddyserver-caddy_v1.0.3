...
import (
	...
	"github.com/haochudao/caddyserver-caddy_v1.0.3/caddyhttp/httpserver"
...
// see https://github.com/haochudao/caddyserver-caddy_v1.0.3/pull/1112#discussion_r80092582
...
func copyHeader(dst, src http.Header) {
	for k, vv := range src {
		if _, ok := dst[k]; ok {
			...
			// see https://github.com/haochudao/caddyserver-caddy_v1.0.3/issues/1086
